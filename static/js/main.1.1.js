...
var page_names = ['page_news', 'page_chats', 'page_home', 'page_settings', 'page_bug_report', 'page_register', 'page_users', 'page_not_found']; // список доступных страниц
...
open_page("page_chats"); // открываем страницу которую пользователь должен увидеть первой
